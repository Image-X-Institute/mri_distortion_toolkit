...
def test_examples_run():
    ...
    from examples import _7_end_to_end

    assert np.allclose(_5_reporting.report._MatchedMarkerVolume.abs_dis, _7_end_to_end.report._MatchedMarkerVolume.abs_dis)
