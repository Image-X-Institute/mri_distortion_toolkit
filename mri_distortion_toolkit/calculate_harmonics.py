...
def calculate_harmonics(MagneticFields, n_order=8, scale=None):
    """
    ...
    G_x_Harmonics = SphericalHarmonicFit(GradXdata, n_order=n_order, r_outer=150, scale=scale[0])
    ...
    G_y_Harmonics = SphericalHarmonicFit(GradYdata, n_order=n_order, r_outer=150, scale=scale[1])
    ...
    G_z_Harmonics = SphericalHarmonicFit(GradZdata, n_order=n_order, r_outer=150, scale=scale[2])
    ...
    try:
        ...
        B0_Harmonics = SphericalHarmonicFit(B0_data, n_order=n_order, r_outer=150, scale=scale[3])
    except KeyError:
        B0_Harmonics = None
