...
# Precise threshold
distorted_volume_12_precise = MarkerVolume(data_loc / '09 gre_trans_AP_330' / 'Original', verbose=True, iterative_segmentation=True, n_markers_expected=336)
...
#
# # Precise threshold
# distorted_volume_14_precise = MarkerVolume(data_loc / '14 gre_cor_RL' / 'Original', verbose=True, iterative_segmentation=True, n_markers_expected=336)
# # will still fail at other guassian values
...
#
# # Precise threshold
# distorted_volume_2_precise = MarkerVolume(data_loc2 / '02 gre_tra_AP' / 'Original', verbose=True, iterative_segmentation=True, n_markers_expected=145)
# # will still fail at other guassian values
