...
gt_data_loc = Path(r'C:\Users\bwhe3635\Downloads\MRI_distortion_QA_sample_data\MRI_distortion_QA_sample_data\CT\slicer_centroids.mrk.json')
...
# G_z_Harmonics.harmonics = G_z_Harmonics.harmonics / 1.55
