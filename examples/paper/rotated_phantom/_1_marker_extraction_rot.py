...
volume = MarkerVolume(dataloc / scans['17'] / 'Original', n_markers_expected=609,
...
volume = MarkerVolume(dataloc / scans['18'] / 'Original', n_markers_expected=609,
                      iterative_segmentation=True,
                      gaussian_image_filter_sd=0.6)
print(f'for {scans["18"]}, {volume.MarkerCentroids.shape[0]} markers found')
volume.export_to_slicer()
volume.save_dicom_data()
