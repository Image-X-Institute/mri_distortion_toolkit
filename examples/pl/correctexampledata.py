...
## Correct itself
data_loc = Path(
    r'C:\Users\pliu4890\OneDrive - The University of Sydney (Staff)\Documents\MRI-Linac\Experiments\20220413 Full sphere foam Goam\20220428 MR Linac^Test')
...
#
# Uncorrected markers
uncorrected_volume = MarkerVolume(data_loc / '09 gre_trans_AP_330' / 'Original' / 'slicer_centroids.mrk.json')
...
GDC = KspaceDistortionCorrector(ImageDirectory=data_loc / '09 gre_trans_AP_330' / 'Original',
...
GDC.save_all_images(foldername='Corrected KD 3D')

# Correct images (image domain example)
IDC = ImageDomainDistortionCorrector(ImageDirectory=data_loc / '09 gre_trans_AP_330' / 'Original',
                                     Gx_Harmonics='G_x_Harmonics.csv',
                                     Gy_Harmonics='G_y_Harmonics.csv',
                                     Gz_Harmonics='G_z_Harmonics.csv',
                                     ImExtension='dcm',
...
IDC.save_all_images(foldername='Corrected ID 3D')
